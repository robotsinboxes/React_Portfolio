    ...
    return (
        <div className="about-container text-center">
            ...
            <div className="about-content">
                ...
                <p>
                    In spring of 2000 I opened a local cafe turned successful, award-winning restaurant. I went back to school for a degree in Accounting, and for the last 15 I was the accountant and office administrator for the business.
                </p>
                <p>
